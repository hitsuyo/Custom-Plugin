...
function mcptp_Add_My_Admin_Link()
{
  add_menu_page(
        ...
        'includes/mcptp-first-acp-page' // The 'slug' - file to display when clicking the link
    );
}
...
function mcptp_plugin_options() {
  ...
  echo '<form action="mcptp_plugin_options" method="get">';
  echo 'Post type name: <input type="text" name="post_name"><br>';
